...
internal class AddFavouriteCommandValidator : AbstractValidator<AddFavouriteCommand>
{
        ...
        IUserRepository userRepository)
    {
        ...
        RuleFor(x => x)
            .MustAsync(async (command, ct) => 
                await IsNotFavouriteAsync(command.ContentId, command.UserId, ct))
            .WithMessage(ErrorMessages.AlreadyFavourite);
    }
    ...
    private async Task<bool> IsNotFavouriteAsync(long contentId, long userId, CancellationToken _)
    {
