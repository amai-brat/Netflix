    ...
    public partial class SeedTestData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -2L, new DateOnly(1999, 3, 22), "testEmail2@gmail.com", "testUser2", "testPassword1337;", "https://st.kp.yandex.net/images/actor_iphone/iphone360_25584.jpg", "user" },
                    { -1L, new DateOnly(2004, 3, 22), "testEmail@gmail.com", "testUser", "testPassword228;", "https://i.pinimg.com/originals/2b/64/2f/2b642f9183fa80b8c47a9d8f8971eb4d.jpg", "user" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, -1L, new DateTimeOffset(new DateTime(2024, 3, 20, 21, 29, 51, 403, DateTimeKind.Unspecified).AddTicks(4783), new TimeSpan(0, 3, 0, 0, 0)), new DateTimeOffset(new DateTime(2024, 4, 21, 21, 29, 51, 403, DateTimeKind.Unspecified).AddTicks(4819), new TimeSpan(0, 3, 0, 0, 0)) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -1L, -1L, new DateTimeOffset(new DateTime(2024, 3, 22, 20, 59, 51, 403, DateTimeKind.Unspecified).AddTicks(4984), new TimeSpan(0, 3, 0, 0, 0)) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -1L, -1L, true, 9, "Невероятный фильм всем рекомендую, очень хороший фильм. Обожаю этот фильм не знаю, что еще сказать. Нет знаешь, нет я не знаю. Ты понял? Скажи! Мы один человек?", -1L, new DateTimeOffset(new DateTime(2024, 3, 22, 21, 29, 51, 403, DateTimeKind.Unspecified).AddTicks(4991), new TimeSpan(0, 3, 0, 0, 0)) });

            migrationBuilder.InsertData(
                table: "comments",
                columns: new[] { "id", "review_id", "text", "user_id", "written_at" },
                values: new object[] { -1L, -1L, "Полностью согласен", -2L, new DateTimeOffset(new DateTime(2024, 3, 22, 21, 39, 51, 403, DateTimeKind.Unspecified).AddTicks(5002), new TimeSpan(0, 3, 0, 0, 0)) });
